...
class ReconPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        self._set_btn_theme(self._scan_btn, "cyan")
        ...
        self._set_btn_theme(self._port_scan_btn, "orange")
        ...
        tree_hdr.setObjectName("section_header")
        tree_layout.addWidget(tree_hdr)

        self._tree = QTreeWidget()
        self._tree.setHeaderLabels(
            ["IP ADDRESS", "MAC ADDRESS", "VENDOR", "OS", "LATENCY", "PORTS"]
        )
        ...
        map_hdr.setObjectName("section_header")
    ...
    def add_device(self, ip: str, mac: str, vendor: str, os_name: str = "Unknown", latency: str = "-"):
    ...
    def refresh_theme(self) -> None:
        """Re-apply dynamic theme colors based on current state."""
        self._status_lbl.setStyleSheet(f"color: {config.COLOR_TEXT_DIM}; font-weight: bold; font-size: 11px;")
        if hasattr(self._topology_map, "refresh_theme"):
            self._topology_map.refresh_theme()
