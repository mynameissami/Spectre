...
import config
from core.hardware.telemetry import list_serial_ports
...
class Banner(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._ref_btn.setFixedSize(28, 28)
        self._ref_btn.setToolTip("Refresh port list")
        ...
        self._ref_btn.clicked.connect(self._refresh_ports)
